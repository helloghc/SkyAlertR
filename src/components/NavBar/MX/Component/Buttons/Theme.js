...
const SVG = {
    OUTLINE:{
        PATH: `M428.756,300.104c-0.664-3.81-2.334-7.047-4.996-9.713c-5.9-5.903-12.752-7.142-20.554-3.716
        ...
        VIEW: `0 0 438.277 438.277`,
    },
    FILL:{
        PATH: `M459.782,347.328c-4.288-5.28-11.488-7.232-17.824-4.96c-17.76,6.368-37.024,9.632-57.312,9.632
...
const Button = ({ buttonThemeChange, theme}) => (
    <RippleButton onClick={e =>buttonThemeChange(e, theme.NAME)} >
        <IconSVG version="1.1"  xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink"  
            viewBox={theme.NAME === 'LIGHT' ? SVG.OUTLINE.VIEW : SVG.FILL.VIEW}>
            <Shape d={theme.NAME === 'LIGHT' ? SVG.OUTLINE.PATH : SVG.FILL.PATH} />
        </IconSVG>
    </RippleButton>
);
